...
This is a **Drepadata** mobile application built with [Expo](https://expo.dev) for managing drépanocytose patient records.
...
This is a native cross-platform mobile app for **Drepadata** - a comprehensive drépanocytose patient management system created with [Rork](https://rork.com)

**Platform**: Native iOS & Android app, exportable to web
**Framework**: Expo Router + React Native
**Purpose**: Medical record management for drépanocytose patients
...
**Drepadata** is a comprehensive drépanocytose patient management system that includes:

- **Patient Registration** - Complete patient profile creation with medical history
- **Consultation Management** - Initial and follow-up consultations with detailed tracking
- **Vaccination Records** - Complete vaccination schedule management and tracking
- **Medical History** - Comprehensive medical records including treatments and complications
- **Search & Filter** - Advanced patient search and filtering capabilities
- **Document Generation** - Export patient records as PDF documents
